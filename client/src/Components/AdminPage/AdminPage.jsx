                ...
                <div style={{ backgroundImage: 'url(require("./images/background.jpg"))' }}>
                    ...
                    <br/>
                        ...
                        <div className="row row-cols-1 row-cols-md-4 g-4">
                            ...
                            <DashCard props={{title:"Gestionar Clientes", image:cameraCinema,redirectLink:"/",params:userLogged,buttonTitle:"Gestionar"}} />                            
    
                            <DashCard props={{title:"Gestionar Cartelera", image:cinema,redirectLink:"/",params:userLogged,buttonTitle:"Gestionar"}} />
                           
                            <DashCard props={{title:"Gestionar Alimentos", image:signOutImage,redirectLink:"/ManageSnack",params:userLogged,buttonTitle:"Gestionar"}} />
